 ...
 */
public abstract class AbstractExtendClientClusterMemberGroupTest extends AbstractTest {
    protected Logger logger = Logger.getLogger(AbstractExtendClientClusterMemberGroupTest.class.getName());

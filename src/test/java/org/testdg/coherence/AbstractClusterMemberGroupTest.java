...
public abstract class AbstractClusterMemberGroupTest extends AbstractTest {
    protected static final String TCMP_CLUSTER_MEMBER_CACHE_CONFIG_FILE = "coherence/testdg-test-cache-config.xml";
    protected static final String EXTEND_CLIENT_CACHE_CONFIG_FILE = "coherence/testdg-test-extend-client-cache-config.xml";

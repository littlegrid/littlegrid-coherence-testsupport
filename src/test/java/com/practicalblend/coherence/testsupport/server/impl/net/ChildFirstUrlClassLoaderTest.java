package com.practicalblend.coherence.testsupport.server.impl.net;
...
public class ChildFirstUrlClassLoaderTest extends AbstractTestSupportTest {
    private static final String CLASS_TO_TRY_AND_LOAD =
            "com.practicalblend.coherence.testsupport.server.impl.net.ChildFirstUrlClassLoaderTest$Dummy";

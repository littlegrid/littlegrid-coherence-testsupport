...
import org.sprinkletest.coherence.support.server.impl.util.SystemUtils;
...
import static org.sprinkletest.coherence.support.SystemPropertyConst.TANGOSOL_COHERENCE_DOT;
...
public class ClientUtils {
    ...
    private static PropertyContainer internalCreateStorageDisabledClientPropertyContainerWithDefaults() {
        PropertyContainer container = new PropertyContainer(ServerFactory.createCacheServerPropertiesWithDefaults());
    ...
    private static PropertyContainer internalCreateExtendClientPropertyContainerWithDefaults() {
        PropertyContainer container = new PropertyContainer(ServerFactory.createGenericClusterMemberPropertiesWithDefaults());
        container.addProperty(DISTRIBUTED_LOCALSTORAGE_KEY, Boolean.FALSE.toString());
